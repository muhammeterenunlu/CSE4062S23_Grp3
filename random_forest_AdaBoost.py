...
def random_forest_classification_adaboost(data):
    # Prepare the dataset
    ...
    # Create the AdaBoost classifier with random forest as the base estimator
    clf = AdaBoostClassifier(base_estimator=base_classifier, n_estimators=20, random_state=42)
