...
def fpgrowth_algorithm():
    ...
    # Run FP-Growth algorithm on the dataframe, with minimum support threshold as 0.6
    ...
    # Save to JSON
    frequent_itemsets.to_json("frequent_itemsets_fp.json", orient='records', lines=True)
